function zoom(componente, idCampoTexto) {
    ...
    if (componente == 'bt_operador') {
        modalzoom.open("Operadores",
            "dsk_encerra_projeto",
            "codigo,Código,nome,Nome",
            "codigo,nome",
            "indacao,OPERADOR,codempresa," + $('#cod_empresa_' + $this.instanceId).val(),
            componente, false, "default", null, null,
            "nome");
    }
    ...
    if (componente == 'bt_item') {
        ...
        modalzoom.open("Itens",
            "dsk_encerra_projeto",
            "codigo,Código,descricao,Item",
            "codigo,descricao",
            "indacao,TITEM,codempresa," + $('#cod_empresa_' + $this.instanceId).val(),
...
function setSelectedZoomItem(selectedItem) {
    ...
    if (campo == 'bt_operador') {
        $('#md_codOperador_' + $this.instanceId).val(selectedItem.codigo);
        $('#md_nomeOperador_' + $this.instanceId).val(selectedItem.nome);
    }

    if (campo == 'bt_item') {
        $('#cod_item_' + $this.instanceId).val(selectedItem.codigo);
    }
}
