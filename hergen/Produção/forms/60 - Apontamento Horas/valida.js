...
var beforeSendValidate = function(numState,nextState){
    ...
    $("input,select,textarea").each(function () {
		...
		|| ( $('#tipo').val() != 'S' && $(this).attr( 'validaEntrada' ) != undefined )
		|| ( $('#tipo').val() != 'E' && $(this).attr( 'validaSaida' ) != undefined ) ){
			
		
			$( $(this) ).css({'background-color' : '#FFFFFF'});
			console.log("ID antes IF...... ", $(this).attr('id') );
			
			if ( $(this).val() == "" || $(this).val() == null || $(this).val() == undefined ){
	
				console.log("ID depois IF...... ", $(this).attr('id'),$(this).attr( 'valida' ),$(this).attr( 'validaEntrada' ),$(this).attr( 'validaSaida' ) );
				
				$( $(this) ).css({'background-color' : '#FFE4C4'});
				
				if ( $(this).attr( 'valida' ) != undefined ) 
					msg += ' '+$(this).attr( 'valida' );
				if ( $(this).attr( 'validaEntrada' ) != undefined ) 
					msg += ' '+$(this).attr( 'validaEntrada' );
				if ( $(this).attr( 'validaSaida' ) != undefined ) 
					msg += ' '+$(this).attr( 'validaSaida' );
				
				console.log("ID depois seq IF...... " );
