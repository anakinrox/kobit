const publicDataset = {
    ...
    retornaToken: function () {
        var token = {
            'public': '8916e6ba-9e3d-4b82-8527-20a4999c705c',
            'secret': 'f5936796-1737-4c0b-a66c-a9ad4ed0441afb8f00b1-4ad2-4e56-8749-e6d00af86501'
        };
        return token;
    },
    ...
    getDataset: function (datasetName, fields, constratins, order, cb) {
        ...
        var self = this;
        var url = 'https://fluig.pormade.com.br:8443' // ou WCMAPI.getServerURL(); para widget fluig
        var d = $.Deferred();
