function zoom(componente, idCampoTexto) {
    ...
    if ((componente == 'bt_user') || (componente == "bt_userF")) {
        modalzoom.open("Usuario Comercial",
            "usuario_comercial",
            "matricula,Matricula,user_crm,CRM,gestor_venda,Gestor,nome_usuario,Usuário",
            "matricula,user_crm,gestor_venda,nome_usuario",
            "",
            componente, false, "default", null, null,
            "nome_usuario");
    }

    if ((componente == 'bt_cadastro') || (componente == 'bt_cadastroF')) {
        modalzoom.open("Tipo Cadastro",
            "dts_metas",
            "CODREGISTRO,Codigo,DESCRICAO,Nome",
            "CODREGISTRO,DESCRICAO",
            "",
            componente, false, "default", null, null,
            "DESCRICAO");
    }
    ...
    if (componente == 'bt_gestor') {
        modalzoom.open("Usuario Comercial",
            "usuario_comercial",
            "gestor_venda,Codigo,nome_gestor_venda,Gestor",
            "gestor_venda,nome_gestor_venda",
            "",
            componente, false, "default", null, null,
            "nome_gestor_venda");
    }
...
function setSelectedZoomItem(selectedItem) {
    ...
    if (campo == 'bt_user') {
        $('#matricula_' + $this.instanceId).val(selectedItem.matricula);
        $('#nome_usuario_' + $this.instanceId).val(selectedItem.nome_usuario);
    }

    if (campo == 'bt_userF') {
        $('#md_matriculaF_' + $this.instanceId).val(selectedItem.matricula);
        $('#md_userCRM_' + $this.instanceId).val(selectedItem.user_crm);
        $('#md_codGestorF_' + $this.instanceId).val(selectedItem.gestor_venda);
        $('#md_nome_usuarioF_' + $this.instanceId).val(selectedItem.nome_usuario);
    }

    if (campo == 'bt_gestor') {
        $('#cod_gestor_' + $this.instanceId).val(selectedItem.gestor_venda);
        $('#nome_gestor_' + $this.instanceId).val(selectedItem.nome_gestor_venda);
    }

    if (campo == 'bt_cadastro') {
        $('#codregistro_' + $this.instanceId).val(selectedItem.CODREGISTRO);
        $('#nome_registro_' + $this.instanceId).val(selectedItem.DESCRICAO);
    }

    if (campo == 'bt_cadastroF') {
        $('#codregistroF_' + $this.instanceId).val(selectedItem.CODREGISTRO);
        $('#nome_registroF_' + $this.instanceId).val(selectedItem.DESCRICAO);
    }
