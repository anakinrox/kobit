function zoom(componente, idCampoTexto) {
    ...
    if ((campo == 'bt_cidade') || (campo == 'md_bt_cidade')) {
        var wEstado = $('#cod_UF_' + $this.instanceId).val();

        if (($('#cod_UF_' + $this.instanceId).val() == "") && ($('#cod_md_UF_' + $this.instanceId).val() == "")) {
            FLUIGC.toast({
        ...
        if (wEstado == '') { wEstado = $('#cod_md_UF_' + $this.instanceId).val(); }

        modalzoom.open("Cidades",
            "dsk_tracking",
            "cidade,Cidades",
            "cidade",
            "endpoint,cidade,uf," + wEstado,
            componente, false, "default", null, null,
            "cidade");
    }
...
function setSelectedZoomItem(selectedItem) {
    ...
    if (campo == "bt_md_uf") {
        $('#cod_md_UF_' + $this.instanceId).val(selectedItem.uf);
        $('#md_UF_' + $this.instanceId).val(selectedItem.nome);
    }
    ...
    if (campo == "md_bt_cidade") {
        $('#md_cod_cidade_' + $this.instanceId).val(selectedItem.cidade);
        $('#md_cidade_' + $this.instanceId).val(selectedItem.cidade);
    }
