function zoom(componente, idCampoTexto) {
    ...
    if (campo == 'bt_veiculo') {
        modalzoom.open("Veículos",
            "DSCadastrodeobjetosdereserva",
            "descricao,Veículo",
            "codigo,descricao",
            "",
            componente, false, "default", null, null,
...
function setSelectedZoomItem(selectedItem) {
    ...
    if (campo == "bt_motorista") {
        $('#cod_motorista_' + $this.instanceId).val(selectedItem.colleagueId);
        $('#motorista_' + $this.instanceId).val(selectedItem.colleagueName);
    }

    if (campo == "bt_veiculo") {
        $('#cod_veiculo_' + $this.instanceId).val(selectedItem.codigo);
        $('#veiculo_' + $this.instanceId).val(selectedItem.descricao);
    }
