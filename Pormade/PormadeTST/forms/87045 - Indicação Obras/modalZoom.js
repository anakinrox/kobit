...
var modalzoom = (function(){
	...
	return {
		open: function(title, dataset, fields, resultfields, filters, type, iniVazio, size, likefield, likevalue, searchby, buttonNew) {

			//parent.$('#workflowView-cardViewer').css( 'zIndex', 1 );
			console.log( parent.$('#workflowview-header') );
...
/*			var cplHtml = '';
			...
			if( buttonNew ){
				button.push( {'label': 'Novo',
							  'classType': 'btn-success zoom-new',
						      'autoClose': true } );
			}
