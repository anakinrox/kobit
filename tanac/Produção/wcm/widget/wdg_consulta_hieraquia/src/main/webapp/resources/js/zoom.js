function zoom(componente, idCampoTexto) {
    ...
    if (componente == 'bt_cadastro') {

        // var wCodigo = $('#indParametro_' + $this.instanceId).val();
    ...
    if (componente == 'bt_filial') {
        ...
        modalzoom.open("Filiais",
            "dsk_hieraquia",
            "nome,Nome",
            "nome,",
            "indacao,ZO,filtro,FIL",
            componente, false, "default", null, null,
            "nome");
    }
    ...
    if (componente == 'bt_secao') {
        ...
        modalzoom.open("Seções",
            "dsk_hieraquia",
            "codigo,Código,nome,Nome",
            "codigo,nome,",
            "indacao,ZO,filtro,SES",
            componente, false, "default", null, null,
            "nome");
    }

    if (componente == 'bt_departamento') {

        modalzoom.open("Departamentos",
            "dsk_hieraquia",
            "nome,Nome",
            "nome,",
            "indacao,ZO,filtro,DEP",
            componente, false, "default", null, null,
            "nome");
    }
    ...
    if (componente == 'bt_funcao') {
        ...
        modalzoom.open("Funções",
            "dsk_hieraquia",
            "codigo,Código,nome,Nome",
            "codigo,nome,",
            "indacao,ZO,filtro,FUNC",
            componente, false, "default", null, null,
            "nome");
    }
...
function setSelectedZoomItem(selectedItem) {
    ...
    if (campo == 'bt_cadastro') {
        $('#cod_cadastro_' + $this.instanceId).val(selectedItem.codigo);
        $('#nome_cadastro_' + $this.instanceId).val(selectedItem.nome);
    }

    if (campo == 'bt_empresa') {
        $('#cod_empresa_' + $this.instanceId).val(selectedItem.nome);
        $('#nome_empresa_' + $this.instanceId).val(selectedItem.nome);
    }

    if (campo == 'bt_filial') {
        $('#cod_filial_' + $this.instanceId).val(selectedItem.nome);
        $('#nome_filial_' + $this.instanceId).val(selectedItem.nome);
    }

    if (campo == 'bt_secao') {
        $('#cod_secao_' + $this.instanceId).val(selectedItem.codigo);
        $('#nome_secao_' + $this.instanceId).val(selectedItem.nome);
    }

    if (campo == 'bt_departamento') {
        $('#cod_departamento_' + $this.instanceId).val(selectedItem.nome);
        $('#nome_departamento_' + $this.instanceId).val(selectedItem.nome);
    }

    if (campo == 'bt_funcao') {
        $('#cod_funcao_' + $this.instanceId).val(selectedItem.codigo);
        $('#nome_funcao_' + $this.instanceId).val(selectedItem.nome);
    }
