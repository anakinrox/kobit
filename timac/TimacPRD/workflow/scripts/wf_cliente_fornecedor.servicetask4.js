...
//	var parentFolder = 296235;
	
//	var parentFolder = 124110;
	var parentFolder = 296235;
	...
	if ( dsPasta.rowsCount > 0 ) {
		...
		vo.setDocumentDescription( hAPI.getCardValue('num_cgc_cpf') + ' - ' + hAPI.getCardValue('raz_social') );
...
//        	var description = doc.getDocumentDescription(); 
