function zoom(componente, idCampoTexto) {
    ...
    if ((componente == 'bt_cargo') || (componente == 'bt_cargoF')) {
        modalzoom.open("Cargos",
            "dts_Cargos",
            "cargo,Cargo",
            "cargo",
            "",
...
function setSelectedZoomItem(selectedItem) {
    ...
    if (campo == 'bt_userF') {
        $('#md_matriculaF_' + $this.instanceId).val(selectedItem.login);
        $('#md_nome_usuarioF_' + $this.instanceId).val(selectedItem.colleagueName);
    }

    if (campo == "bt_cargo") {
        $('#cargo_' + $this.instanceId).val(selectedItem.cargo);
        $('#nome_cargo_' + $this.instanceId).val(selectedItem.cargo);
    }

    if (campo == "bt_cargoF") {
        $('#cargoF_' + $this.instanceId).val(selectedItem.cargo);
        $('#nome_cargoF_' + $this.instanceId).val(selectedItem.cargo);
    }
