...
function loadRepres( cod_repres ){
	...
	try{
		...
		if ( dsRepCpl != null && dsRepCpl.rowsCount>0){
			log.info("## parametros ## "+ dsRepCpl.getValue(0, "perc_mix_ger_sup_reg") );
			hAPI.setCardValue("perc_mix_ger_sreg", dsRepCpl.getValue(0, "perc_mix_sup_reg") );
			hAPI.setCardValue("perc_desc_ger_sreg", dsRepCpl.getValue(0, "perc_desc_sup_reg") );
		}
