var beforeSendValidate = function(numState,nextState){
	...
	if( numState == 2 && $('#etapa').val() != 8 ){
		msg = 'Você somente pode movimentar o processo ao chegar na etapa 8!';
	}
	
	if( numState != 2 && $('#etapa').val() != 7 && $('#tipCadUser').val() != 'A'){
		msg = 'Você somente pode movimentar o processo ao chegar na etapa 7!';
	}
